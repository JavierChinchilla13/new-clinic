    ...
    <div className="flex flex-col items-center">
      ...
      <div className="w-full flex flex-col md:flex-row justify-center items-start p-8 space-y-4 md:space-y-0 md:space-x-8">
        ...
        <div className="flex flex-col items-start space-y-2">
          ...
          <p className="text-gray-700"><span role="img" aria-label="pin">📍</span> Sabana, Multicentro Sabana.</p>
        ...
        <div className="w-full md:w-1/4 flex justify-center items-center">
          <img src="/path/to/contact-image.jpg" alt="Persona recibiendo tratamiento" className="rounded-md" />
        </div>
      </div>
    </div>
  );
